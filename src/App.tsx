...
export default function App() {
  ...
  return (
    <div style={{ background: 'var(--bg)' }} className="h-screen w-screen transition-colors duration-200">
      <BrowserRouter>
        <div className="flex h-full">

          {/* Frosted glass sidebar */}
          <aside
            className="w-52 flex-shrink-0 flex flex-col gap-0.5 p-3 border-r"
            style={{
          ...
          >
            <p
              className="text-[13px] font-semibold px-2 pb-3 tracking-tight"
